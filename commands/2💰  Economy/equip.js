...
module.exports = {
    ...
    async execute(msg, args) {
        ...
        if (item.TYPE == "SWORD") {
            ...
            if (!old) { player.WEAPON = "0"; } else { emb.addField("Voherige Waffe", (old.NAME + " [" + old.ATK + "/" + old.DEV + "]")) }
            ...
            if (!old) { player.SHIELD = "0"; } else { emb.addField("Voheriges Schild", (old.NAME + " [" + old.ATK + "/" + old.DEV + "]")) }
